...
import { handleValidationCreateTopic, handleValidationUpdateTopic } from '../../../utils/validate'
...
const TopicAdminScreen = () => {
  ...
  return (
    <div className="pt-10 px-6 bg-gray-200">
      ...
      <div>
        <BaseButton handleClick={() => setShowCreateForm(true)} title='Thêm Topic' className='px-6' />
      </div>
      {topicsIsSuccess ? (
        <div className="pt-10">
            ...
            <Form>
              <Form.Item>
                ...
                >
                  ...
                  {subjectIsSuccess && subjects.data.map((item) => (
                    <option
